...
typedef struct {
    ...
    volatile uint8_t LAPS;                        //Number of completed laps
    ...
    volatile uint8_t REG_BTN_STATE;
    ...
    volatile double INVERTER_MAX_TEMP;
    
    volatile double MOTOR_FL_TEMP;
    volatile double MOTOR_FR_TEMP;
    volatile double MOTOR_RL_TEMP;
    volatile double MOTOR_RR_TEMP;
    volatile double MOTOR_MAX_TEMP;

    volatile double CELL_MAX_TEMP;                //HV battery maximum cell temperature
