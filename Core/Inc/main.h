...
#define RAD_FANS_PWM_OUT_TIM_PWM_Pin GPIO_PIN_8
#define RAD_FANS_PWM_OUT_TIM_PWM_GPIO_Port GPIOB
#define TSAC_FANS_PWM_OUT_TIM_PWM_Pin GPIO_PIN_9
#define TSAC_FANS_PWM_OUT_TIM_PWM_GPIO_Port GPIOB
