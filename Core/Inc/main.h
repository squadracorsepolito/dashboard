...
#define nIMD_ERR_LED_CMD_GPIO_OUT_Pin GPIO_PIN_3
#define nIMD_ERR_LED_CMD_GPIO_OUT_GPIO_Port GPIOC
...
#define nAMS_ERR_LED_CMD_GPIO_OUT_Pin GPIO_PIN_2
#define nAMS_ERR_LED_CMD_GPIO_OUT_GPIO_Port GPIOA
